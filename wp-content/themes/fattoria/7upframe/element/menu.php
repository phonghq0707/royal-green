...
vc_map( array(
    "name"          => esc_html__("Menu", 'fattoria'),
    "base"          => "s7upf_menu",
    "icon"          => "icon-st",
    "category"      => esc_html__("7UP-Elements", 'fattoria'),
    "description"   => esc_html__( 'Display menu navigation', 'fattoria' ),
    "params"        => array(
        array(
            "type"          => "dropdown",
            "admin_label"   => true,
            ...
            "param_name"    => "style",
            "value"         => array(
                esc_html__("Default",'fattoria')   => 'main-nav1',
                esc_html__("Style 2 (Button)",'fattoria')   => 'main-nav2',
            ),
        ...
        array(
            "type"          => "dropdown",
            "admin_label"   => true,
            "heading"       => esc_html__("Menu Sticky",'fattoria'),
            "param_name"    => "menu_sticky",
            "value"         => array(
                esc_html__("Off",'fattoria')   => '',
                esc_html__("On",'fattoria')   => 'menu-sticky-on',
            ),
            "description"   => esc_html__( 'Choose menu style to display.', 'fattoria' )
        ),
        array(
            'type'          => 'dropdown',
            "admin_label"   => true,
            'heading'       => esc_html__( 'Menu name', 'fattoria' ),
            'param_name'    => 'menu',
            'value'         => s7upf_list_menu_name(),
            'description'   => esc_html__( 'Select Menu name to display.', 'fattoria' )
        ),        
        array(
            "type"          => "textfield",
