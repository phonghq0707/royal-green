...
if(!class_exists('S7upf_Woocommerce_Attributes')){
    class S7upf_Woocommerce_Attributes{
        ...
        static function s7upf_product_option_terms_attribute( $taxonomy, $index ) {
            $types = array(
                'color' => esc_html__( 'Color', 'fattoria' ),
                'image' => esc_html__( 'Image', 'fattoria' ),
                'label' => esc_html__( 'Label', 'fattoria' ),
            );
            ...
            <select multiple="multiple" data-placeholder="<?php esc_attr_e( 'Select terms', 'fattoria' ); ?>" class="multiselect attribute_values wc-enhanced-select" name="attribute_values[<?php echo esc_attr($index); ?>][]">
                <?php
            ...
            <button class="button plus select_all_attributes"><?php esc_html_e( 'Select all', 'fattoria' ); ?></button>
            <button class="button minus select_no_attributes"><?php esc_html_e( 'Select none', 'fattoria' ); ?></button>
            <button class="button fr plus tawcvs_add_new_attribute" data-type="<?php echo esc_attr($taxonomy->attribute_type); ?>"><?php esc_html_e( 'Add new', 'fattoria' ); ?></button>
