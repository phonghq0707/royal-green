...
if(!class_exists('S7upf_Group_Begin'))
{
    class S7upf_Group_Begin extends WP_Widget {
        ...
        {
            if(function_exists('s7upf_reg_widget')) s7upf_reg_widget( 'S7upf_Group_Begin' );
        }

        function __construct() {
            // Instantiate the parent object
            parent::__construct( false, esc_html__('Group begin','fattoria'),
                array( 'description' => esc_html__( 'Begin a Group', 'fattoria' ), ));
        ...
        function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'el_class' )); ?>"><?php esc_html_e( 'Wrap class:' ,'fattoria'); ?></label>
