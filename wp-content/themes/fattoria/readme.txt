...
== Description ==
Our 2015 default theme is clean, blog-focused, and designed for clarity. 7upframework's simple, straightforward typography is readable on a wide variety of screen sizes, and suitable for multiple languages. We designed it using a mobile-first approach, meaning your content takes center-stage, regardless of whether your visitors arrive by smartphone, tablet, laptop, or desktop computer.
...
You can change the colors of your site easily using 7upframework.
...
7upframework allows you display links to your social media profiles, like Twitter and Facebook, with icons.
...
7upframework sports a menu design that's easy to navigate -- especially when you add menu descriptions.
