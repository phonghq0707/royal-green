...
if ( ! function_exists( 'famibt_col_select_html' ) ) {
	function famibt_col_select_html( $selected = 'display_col_4', $class = '', $name = '', $id = '', $echo = true ) {
		$args = array(
			'display_col_6' => esc_html__( '6 Columns', '7up-together' ),
			'display_col_5' => esc_html__( '5 Columns', '7up-together' ), // No 5 columns options
			'display_col_4' => esc_html__( '4 Columns', '7up-together' ),
			'display_col_3' => esc_html__( '3 Columns', '7up-together' ),
			'display_col_2' => esc_html__( '2 Columns', '7up-together' ),
			'display_col_1' => esc_html__( '1 Column', '7up-together' ),
		);
