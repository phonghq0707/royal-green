        ...
        public function famibt_content() {
            if ( is_singular( 'product' ) ) {
                ...
                if ( trim( $title ) != '' && $this->famibt_hook != 'woocommerce_product_tabs' ) {
                    $title_html = '<h3 class="famibt-title title18 font-bold lemonada-font">' . esc_html( $title ) . '</h3>';
                }
                ...
                $left_part_html             = '<div class="famibt-left-part">'. $title_html . $famibt_products_list_html . $famibt_checkboxs_list_html . '</div>';
                ...
                $title_total			  = '<h3 class="title-total title18 lemonada-font font-bold">'.sprintf( esc_html__('Price for all product','fattoria')).'</h3>';
				$right_part_html          = '<div class="famibt-right-part">' .$title_total. $total_price_html . $add_all_to_cart_btn_html . '</div>';
                $buy_together_html = '<div class="famibt-wrap famibt-auto-clear">
								' . $short_desc_html . '
								<div class="row">
		                        	<div class="col-xs-12 col-sm-8">' . $left_part_html . '</div>
			                     	<div class="col-xs-12 col-sm-4">' . $right_part_html . '</div>
			                     </div>
			                     ' . $after_text_html . '
								</div>';
