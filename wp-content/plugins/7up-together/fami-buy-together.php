<?php
/**
 * Plugin Name: 7up Together
 * Plugin URI: #
 * Description: Group of products sold together
 * Author: 7uptheme
 * Author URI: #
 * Version: 1.0
 * Text Domain: 7up-together
 *
 *
 *
 */
...
if ( ! class_exists( 'famiBuyTogether' ) ) {
    ...
    class  famiBuyTogether {
        ...
        public function load_textdomain() {
            load_plugin_textdomain( '7up-together', false, FAMIBT_URI . 'languages' );
        }

        public function product_data_tabs( $tabs ) {
            $tabs['famibt'] = array(
                'label'  => esc_html__( 'Buy Together', '7up-together' ),
        ...
        public function product_data_panels() {
            ...
            <div id='famibt_settings' class='panel woocommerce_options_panel famibt-table-wrap'>
                ...
                <table class="famibt-table">
                    <tr>
                        <td width="250"><?php esc_html_e( 'Enable Buy Together', '7up-together' ); ?></td>
                        <td>
                    ...
                    <tr>
                        <td width="250"><?php esc_html_e( 'Search', '7up-together' ); ?></td>
                        <td>
                            <div class="famibt-inner-wrapper">
                                <div class="famibt-search-product-wrapper">
                                    <input type="text" id="famibt_keyword"
                                           placeholder="<?php esc_html_e( 'Type any keyword to search', '7up-together' ); ?>"/>
                    ...
                    <tr>
                        <td width="250"><?php esc_html_e( 'Selected', '7up-together' ); ?></td>
                        <td>
                            <div class="famibt-inner-wrapper">
                    ...
                    <tr>
                        <td width="250"><?php esc_html_e( 'Buy Together Title', '7up-together' ); ?></td>
                        <td>
                            <div class="famibt-inner-wrapper">
                                <input id="famibt_title" name="famibt_title" type="text"
                                       placeholder="<?php esc_attr_e( 'Buy Together Title', '7up-together' ); ?>"
                                       value="<?php echo esc_attr( stripslashes( get_post_meta( $post_id, 'famibt_title', true ) ) ); ?>"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td width="250"><?php esc_html_e( 'Short Description', '7up-together' ); ?>
                            <br><em><?php esc_attr_e( 'Display after bundle title', '7up-together' ); ?></em></td>
                        <td>
                            <div class="famibt-inner-wrapper">
								<textarea id="famibt_short_desc" name="famibt_short_desc"
                                          placeholder="<?php esc_html_e( 'The text display after title and before list of products', '7up-together' ); ?>"><?php echo stripslashes( get_post_meta( $post_id, 'famibt_short_desc', true ) ); ?></textarea>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td width="250"><?php esc_html_e( 'After Text', '7up-together' ); ?>
                            <br><em><?php esc_attr_e( 'Display after list of products', '7up-together' ); ?></em></td>
                        <td>
                            <div class="famibt-inner-wrapper">
								<textarea id="famibt_after_text" name="famibt_after_text"
                                          placeholder="<?php esc_html_e( 'The text display after list of products', '7up-together' ); ?>"><?php echo stripslashes( get_post_meta( $post_id, 'famibt_after_text', true ) ); ?></textarea>
                            </div>
                        </td>
                    </tr>
                </table>
