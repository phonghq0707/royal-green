...
<?php if(s7upf_check_verify()){?>
    ...
    Reading config when import error <a href="http://7uptheme.com/wordpress/forum/forums/topic/import-demo-content-error/">Click here?</a>
        </p>
    ...
    <br>
        <a href="#" onclick="return false" data-url="<?php echo admin_url('?7up_do_import=1') ?>" class="btn_stp_do_import button button-primary"><?php _e('Import Now','7up-core')?></a>
        <a href="#" onclick="return false" data-url="<?php echo admin_url('?7up_do_import=1&media=0') ?>" class="btn_stp_do_import button button-primary"><?php _e('Import Without Media','7up-core')?></a>
        <a href="#" onclick="return false" data-url="<?php echo admin_url('?7up_do_import=1&media=2') ?>" class="btn_stp_do_import button button-primary"><?php _e('Import Media','7up-core')?></a>
    <div id="import_debug">
    </div>
    <?php
}
